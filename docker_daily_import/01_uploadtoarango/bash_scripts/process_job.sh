...
# Upload the file
curl --data-binary "@${work_path}" -v -u "${usr_pwd}" -H "Content-Type: application/json" -X POST  "http://${server_addr}/_db/${db_name}/_api/import?collection=${collection_name}&type=auto"
