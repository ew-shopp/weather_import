...
echo '#'
echo '#  Starting Process: Extract GRIB weather data'
echo '#'
...
echo "Running:  python main.py ${work_path} ${regions_csv} ${work_path_results}  "
python main.py ${work_path} ${regions_csv} ${work_path_results}  
