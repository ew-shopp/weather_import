...
#            'sf/spain_cities_201701_forecast_combined.json',
#            'sf/spain_cities_201701_forecast_separate.json')

wf2j02 = Weather_forecast_2_json(we,
            'sf/spain_cities_201702_forecast_combined.json',
            'sf/spain_cities_201702_forecast_separate.json')

wf2j03 = Weather_forecast_2_json(we,
            'sf/spain_cities_201703_forecast_combined.json',
            'sf/spain_cities_201703_forecast_separate.json')

wf2j04 = Weather_forecast_2_json(we,
            'sf/spain_cities_201704_forecast_combined.json',
            'sf/spain_cities_201704_forecast_separate.json')

wf2j05 = Weather_forecast_2_json(we,
            'sf/spain_cities_201705_forecast_combined.json',
            'sf/spain_cities_201705_forecast_separate.json')

wf2j06 = Weather_forecast_2_json(we,
            'sf/spain_cities_201706_forecast_combined.json',
            'sf/spain_cities_201706_forecast_separate.json')

wf2j07 = Weather_forecast_2_json(we,
            'sf/spain_cities_201707_forecast_combined.json',
            'sf/spain_cities_201707_forecast_separate.json')

wf2j08 = Weather_forecast_2_json(we,
            'sf/spain_cities_201708_forecast_combined.json',
            'sf/spain_cities_201708_forecast_separate.json')

wf2j09 = Weather_forecast_2_json(we,
            'sf/spain_cities_201709_forecast_combined.json',
            'sf/spain_cities_201709_forecast_separate.json')

wf2j10 = Weather_forecast_2_json(we,
            'sf/spain_cities_201710_forecast_combined.json',
            'sf/spain_cities_201710_forecast_separate.json')

wf2j11 = Weather_forecast_2_json(we,
            'sf/spain_cities_201711_forecast_combined.json',
            'sf/spain_cities_201711_forecast_separate.json')

wf2j12 = Weather_forecast_2_json(we,
            'sf/spain_cities_201712_forecast_combined.json',
            'sf/spain_cities_201712_forecast_separate.json')
